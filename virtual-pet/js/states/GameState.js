var GameState = {
  create: function () {
    ...
    this.candy.customParams = { health: -10, fun: 30 };
    ...
    this.statusDecreaser = this.game.time.events.loop(Phaser.Timer.SECOND * 5,
  ...
  placeItem: function (background, event) {
